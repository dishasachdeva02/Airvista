            ...
            <Link href="/"><Image src="/assets/3.png" height={100} width={100} alt="nav_image"/></Link>
                    ...
                    <div className="flex gap-4 flex-col md:flex-row">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-slate-500 text-sm hover:text-slate-800 transition-all duration-300 cursor-pointer">+91 8383050980</p>
                        </div>
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-slate-500 text-sm hover:text-slate-800 transition-all duration-300 cursor-pointer">dishasachdeva02@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <div className="py-4 mt-2 border-t border-slate-300">
                <p className="text-xs text-slate-500">&copy; Copyright 2023 Disha Sachdeva</p>
            </div>
        </div>
    )
}
